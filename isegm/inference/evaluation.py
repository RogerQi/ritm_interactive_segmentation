...
def evaluate_sample(image, gt_mask, predictor, max_iou_thr,
                    ...
                    sample_id=None, callback=None, init_clicks=None):
    clicker = Clicker(gt_mask=gt_mask, init_clicks=init_clicks)
    ...
    ious_list = [iou] # record initial clicks and interacitve clicks
...
def infer_sample_no_gt(image, predictor, init_clicks, pred_thr=0.49):
